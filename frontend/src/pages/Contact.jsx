    ...
    <section className="bg-white">
      <div className="py-8 lg:py-16 px-4 mx-auto max-w-screen-md">
        ...
        <p className="mb-8 lg:mb-16 font-light text-center text-gray-500 sm:text-xl">
          Have a question about selling crops, detecting plant diseases, or
          fertilizer suggestions? Reach out and we'll get back to you.
        </p>
        <form action="#" className="space-y-8">
          ...
          <div>
            ...
            <input
              ...
              placeholder="e.g., Fertilizer recommendation for wheat"
              required
            />
          </div>
